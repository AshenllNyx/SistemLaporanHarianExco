...
@section('content')
<h2 style="font-size:22px;font-weight:700">Adakah terdapat isu di dewan makan?</h2>

<div style="background:white;padding:20px;border-radius:12px;box-shadow:0 6px 18px rgba(2,6,23,0.06)">
    <p>Sila pilih sama ada anda ingin mencatat laporan dewan makan untuk laporan ini.</p>

    <div style="display:flex;gap:12px;margin-top:12px">
        {{-- Button YA --}}
        <form method="GET" action="{{ route('laporan.dewanmakan.create', $laporan->id_laporan) }}" style="display:inline">
        ...
        {{-- Button TIDAK --}}
        <form method="GET" action="{{ route('laporan.review', $laporan->id_laporan) }}" style="display:inline">
