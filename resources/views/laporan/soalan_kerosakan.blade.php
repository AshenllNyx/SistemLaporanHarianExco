...
@section('content')
<h2 style="font-size:22px;font-weight:700">Adakah terdapat kerosakan?</h2>

<div style="background:white;padding:20px;border-radius:12px;box-shadow:0 6px 18px rgba(2,6,23,0.06)">
    <p>Sila pilih sama ada anda ingin mencatat laporan kerosakan untuk laporan ini.</p>

    <div style="display:flex;gap:12px;margin-top:12px">
        {{-- Button YA --}}
        <form method="GET" action="{{ route('laporan.kerosakan.create', $laporan->id_laporan) }}" style="display:inline">
