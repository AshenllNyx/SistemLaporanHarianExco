...
<div style="background:white;padding:32px;border-radius:24px;box-shadow:0 10px 40px rgba(0,0,0,0.05);border:1px solid #f1f5f9">
    <form method="POST" action="{{ route('laporan.dewanmakan.store') }}">
        ...
        <div style="display: flex; justify-content: space-between; align-items: center; border-top: 1px solid #f1f5f9; padding-top: 32px;">
            ...
            <button type="submit" 
                    style="background: #10b981; color: white; padding: 14px 32px; border-radius: 14px; border: none; font-weight: 700; cursor: pointer; box-shadow: 0 4px 12px rgba(16,185,129,0.2); font-size: 15px;">
