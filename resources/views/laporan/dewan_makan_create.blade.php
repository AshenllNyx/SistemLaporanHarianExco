...
@section('content')
<h2 style="font-size:22px;font-weight:700">Borang Laporan Dewan Makan</h2>
...
<div style="background:white;padding:18px;border-radius:12px;box-shadow:0 6px 18px rgba(2,6,23,0.06)">
    <form method="POST" action="{{ route('laporan.dewanmakan.store') }}">
        ...
        <div style="margin-bottom:12px">
            <label style="font-weight:600;display:block">Jenis Isu</label>
            <input type="text" name="jenis_isu" required style="width:100%;padding:10px;border-radius:8px;border:1px solid #d1d5db" placeholder="Contoh: Makanan tidak mencukupi, Kebersihan kurang, Kelewatan hidangan" />
        </div>

        <div style="margin-bottom:12px">
            <label style="font-weight:600;display:block">Masa Makan</label>
            <select name="masa_makan" style="width:100%;padding:10px;border-radius:8px;border:1px solid #d1d5db">
                <option value="">-- Pilih Masa Makan --</option>
