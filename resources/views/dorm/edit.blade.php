...
<div style="max-width:900px;margin:0 auto">
    ...
    <div style="background:white;padding:20px;border-radius:12px;box-shadow:0 6px 18px rgba(2,6,23,0.06);margin-bottom:20px">
        <form action="{{ route('dorms.update', $dorm->id_dorm) }}" method="POST">
            ...
            <div style="text-align:right">
                <button style="padding:10px 16px;border-radius:8px;background:#2563eb;color:white;border:none;font-weight:600">
                    Simpan Perubahan
                </button>
            </div>
        </form>
    ...
    <div style="background:white;padding:20px;border-radius:12px;box-shadow:0 6px 18px rgba(2,6,23,0.06)">
        ...
        {{-- TAMBAH --}}
        <div style="background:#f0f9ff;padding:16px;border-radius:8px;border:1px solid #bfdbfe;margin-bottom:20px">
            <div style="display:grid;grid-template-columns:1fr 1fr 1fr auto;gap:10px">
                <input id="newIc" placeholder="No. IC"
                    style="padding:10px;border:1px solid #60a5fa;border-radius:8px">
                ...
                <button onclick="addMemberAjax()"
                    style="padding:10px 16px;background:#3b82f6;color:white;border:none;border-radius:8px;font-weight:600">
                    Tambah
                </button>
            </div>
        </div>
        ...
        <table style="width:100%;border-collapse:collapse">
            <thead>
                <tr style="background:#f9fafb;border-bottom:2px solid #e5e7eb">
                    ...
                    <th style="padding:12px">No. IC</th>
                    <th style="padding:12px">Nama</th>
                    <th style="padding:12px">Jantina</th>
        ...
        <tr style="border-bottom:1px solid #f3f4f6">
            ...
            <td style="padding:12px;text-align:center;display:flex;gap:6px;justify-content:center">
                <button onclick="updateMember(${m.id})"
                    style="padding:6px 12px;background:#22c55e;color:white;border:none;border-radius:6px;font-weight:600">
                    Update
                </button>
                <button onclick="removeMember(${i})"
                    style="padding:6px 12px;background:#ef4444;color:white;border:none;border-radius:6px;font-weight:600">
                    Padam
                </button>
            </td>
        </tr>
